...
* bloque lógico indicado por parámetro. Además obtiene la dirección almacenada 
...
*
* return: devuelve la posición fisica del bloque leído o bien leído y reservado.
*/
